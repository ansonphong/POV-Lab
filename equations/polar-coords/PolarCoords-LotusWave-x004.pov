...
#while( i < n )
	...
	#declare shape1 =  0 + Lotus * sin( theta* pow( 2, 9 ) + pi ) * abs( sin( theta*4 + globalR ) );
...
#while( i < n )
	...
	#declare pulse = floor( seq * c - 0.0000001) / c;
	#declare frame = sin( pulse * pi );
	#declare shape1 =  cc + Lotus + sin( theta* pow( 2, 9 ) + pi/2 + globalR*2 ) * abs( sin( theta*4 + globalR ) );
	#declare Radius = 0 + shape1 ;
...
#while( i < n )
	...
	#declare pulse = floor( seq * c - 0.0000001) / c;
	#declare frame = sin( pulse * pi );
	#declare shape1 =  6 + Lotus + sin( theta* pow( 2, 9 ) + pi + globalR ) * abs( sin( theta*4 ) );
	#declare Radius = 0 + shape1 ;
