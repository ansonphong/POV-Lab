...
#while( i < n )
	...
	#declare Diameter = 2/(150 - 50 * sin(theta*4 - pi/2));				// Sphere Diameter
	...
	#declare shapes = 2 + 2 * sin( theta * 2 ) + round( theta / 20 )/(pi/2) + round( sin( theta * 64 + pi/2 ) ) / 2;
	#declare Radius = pulse * 4 + shapes;
