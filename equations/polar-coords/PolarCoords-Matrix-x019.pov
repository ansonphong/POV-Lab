...
#while( i < n )
	...
	#declare Diameter = 4/150; //(150 - 50 * sin(theta*4 - pi/2));				// Sphere Diameter
	...
	#declare lo = 	3;		// In/Out Curve Ratio
	...
	#declare shapes =  cc + Lotus * pulse;
	#declare Radius = 0 + pulse * 3 + shapes ;
