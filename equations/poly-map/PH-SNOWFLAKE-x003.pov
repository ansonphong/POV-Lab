...
#declare h = 24;						// Haromonic
#declare c = 2;						// Circles
#declare i = 0;						// Current Iteration
#declare n = h * 240; 			// Number of Iterations
...
#macro weaveA( si )
	...
	#local depth = 1;
	#local weave = innerRadius + ( cos( si * pi/12 * h / 4 ) ) * depth;
	weave
#end
